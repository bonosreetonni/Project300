...
<!-- aikane ami active inactive ar dlt er kaj korechi logiig dia  -->
											...
											<a class="btn btn-info" href="<?php echo base_url("Edit-Category-Form/$category->category_id") ?>" title="Edit-Status">
											...
											<a class="btn btn-danger" href="<?php echo base_url("change-category-status/$category->category_id/3") ?>" title="delete-Status">
