		...
		<section id="do_action">
			<div class="container">
				<div class="heading">
					...
					<p>Chose a payment method and place order</p>
				</div>
				<div class="row">
					<!-- bndo div tate cupon aro onno discount use korar system ase --> 
					<!-- <div class="col-sm-6">
					...
					<div class="col-sm-6">
						<div class="total_area">
							...
							<ul>
								<form method="post" action="<?php echo base_url()?>Place-order">
									<li>
									...
									<input type="submit" name="btn" class="btn btn-default check_out" value="Place Order">
								</form>
								</ul>
